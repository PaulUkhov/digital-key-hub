...
import com.audio.service.EmailService;
...
public class ThymeleafEmailService implements EmailService {
    ...
    @Override
    public void sendPaymentReceipt(String to, String subject, Map<String, Object> templateData) {
        try {
    ...
    @Override
    public void sendPasswordResetEmail(String to, String resetLink) throws EmailSendingException {
        // TODO
    }
}
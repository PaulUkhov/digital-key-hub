...
@Schema(description = "Response object for purchased product including digital content")
...
public record ProductResponsePaid(
        ...
        @Schema(description = "Digital content access information", example = "https://example.com/download/123")
